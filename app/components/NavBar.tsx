...
//     return (
//         <section className='bg-white flex flex-row lg:flex-col'>
...
//            </Link> <div className='h-[38px] w-6/12 border border-blue-100/60 hidden lg:flex place-items-center p-4 rounded-lg'>
...
// <button type="button" className='p-2 hover:bg-gray-100'><Link href="/products" className='text-sm text-gray-900 font-semibold'>Products</Link></button>

// <div className=" cursor-pointer"
//   onMouseEnter={() => setCollectionIsOpen(true)}
//   onMouseLeave={() =>setCollectionIsOpen(false)}>

// <button type="button" className="flex items-center p-2 relative hover:bg-gray-100 text-sm text-gray-900 font-semibold">
//     Collections <MdKeyboardArrowDown size={18} className='ml-1 rotate-0 hover:rotate-180' />
// </button>
// {
//  collectionIsOpen && (
//     <div className=" p-8 left-4 flex gap-x-8 h-72 rounded-lg w-84 bg-white absolute border-2 border-gray-50 shadow-xl">
...
//         <Link href=""><div className='hover:bg-gray-100 p-4'>
//         <h3 className='text-sm text-gray-900 font-semibold'>New Arrivals</h3>
//         <p className='text-xs text-gray-500'>Shop our new arrivals aand exclusive collections</p>
//         </div></Link>
//         <Link href=""><div className='hover:bg-gray-100 p-4'>
...
//         </div></Link>
//         <Link href=""> <div className='hover:bg-gray-100 p-4 mb-8'>
...
// <button type="button" className="flex items-center p-2 relative hover:bg-gray-100 text-sm text-gray-900 font-semibold">
//     Featured Sellers <MdKeyboardArrowDown size={18} className='ml-1 rotate-0 hover:rotate-180' />
// </button>
// { featuredSellerIsOpen && (
// <div className="absolute h-72 w-80 bg-white flex flex-col">
//   <div className="flex justify-between p-4">
//   <Link href=""><div className='hover:bg-gray-100 p-4'>
//     <h3 className='text-gray-950 font-medium text-md'> Tim's Toys
//       </h3>
                    ...
                    {collectionIsOpen && (
                        <div className="p-8 left-4 flex gap-x-8 h-72 mt-2 rounded-lg w-84 bg-white absolute border-2 border-gray-50 shadow-xl">
                            ...
                            <div className='flex flex-col gap-y-1 h-full w-[60%] pr-8'>
                                ...
                                <Link href="">
                                    <div className='hover:bg-gray-100 p-4 mb-8'>
                                        <h3 className='text-md text-gray-900 font-semibold'>Summer Sale</h3>
                                        <p className='text-sm text-gray-500'>Grab a bargain with our summer sale</p>
                                    </div>
                                </Link>
